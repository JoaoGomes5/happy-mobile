...
export default function OrphanageDetails() {
  ...
  if(!orphanage){
    ...
    function handleOpenGoggleMapsRoute(){
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoggleMapsRoute} style={styles.routesContainer}>
            <Text style={styles.routesText}>Ver caminho no Google Maps</Text>
          </TouchableOpacity>
        </View>
